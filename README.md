...
## Environments
- Preview: https://main--itc-lets-boing--aemysites.aem.page/
- Live: https://main--itc-lets-boing--aemysites.aem.live/
- Block Library: https://main--itc-lets-boing--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `itc-lets-boing` directory in your favorite IDE and start coding :)
